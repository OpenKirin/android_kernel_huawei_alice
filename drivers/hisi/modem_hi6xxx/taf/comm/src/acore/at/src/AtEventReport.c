...
TAF_VOID At_CsMsgProc(MN_AT_IND_EVT_STRU *pstData,TAF_UINT16 usLen)
{
    ...
    switch( enEvent )
    {
        ...
        case TAF_CALL_EVT_SEND_FLASH_CNF:
            AT_RcvTafCallSndFlashCnf(pstData);
            break;
...
TAF_VOID At_PhIndProc(TAF_UINT8 ucIndex, TAF_PHONE_EVENT_INFO_STRU *pEvent)
{
    switch(pEvent->PhoneEvent)
    {
        ...
        case TAF_PH_EVT_MM_INFO_IND:
            /* Added by L60609 for V7R1C50 AT&T&DCM, 2012-6-28, begin */
            AT_RcvMmInfoInd(ucIndex, pEvent);
            /* Added by L60609 for V7R1C50 AT&T&DCM, 2012-6-28, end */
            return;
...
)
{
    ...
    /* Modified by s46746 for DSDA GUNAS C CORE, 2013-01-11, begin */
    ...
    /* Modified by s46746 for DSDA GUNAS C CORE, 2013-01-11, end */
