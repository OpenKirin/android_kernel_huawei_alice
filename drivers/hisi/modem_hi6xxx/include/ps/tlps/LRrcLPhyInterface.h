...
enum LRRC_LPHY_MSG_ID_ENUM
{
    ...
    /*l00277962 write nv begin*/
    ID_LRRC_LPHY_NV_WRITE_RSP                      = (ERRC_LPHY_MSG_HDR + 0x25),
    /*l00277962 write nv end*/
    /*begin: hifi sync switch */
    ID_LRRC_LPHY_HIFI_SYNC_SWITCH_IND           = (ERRC_LPHY_MSG_HDR + 0x26),   /* _H2ASN_MsgChoice LRRC_LPHY_HIFI_SYNC_SWITCH_IND_STRU */
    ...
    /*begin: hifi sync switch */
    ID_LRRC_LPHY_VOICE_SYNC_IND                  = (LPHY_ERRC_MSG_HDR + 0x2b),   /* _H2ASN_MsgChoice LRRC_LPHY_VOICE_SYNC_IND_STRU */
    /*end: hifi sync switch */
    ID_LRRC_LPHY_BUTT
};
