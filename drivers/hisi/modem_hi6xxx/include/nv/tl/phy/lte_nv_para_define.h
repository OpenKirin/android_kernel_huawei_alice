...
typedef struct
{
    UINT8      ucEagleFlg; /*ucEagleFlg :1 表示 pa芯片使用的是eagle ，0表示是其他pa芯片*/
    UINT8      ucRsv;/*预留项*/
    UINT16      usRsv;/*预留项*/
}EAGLE_PA_FLAG_STRU;
typedef struct
{
    EAGLE_PA_FLAG_STRU  stBandEagleFlg[MAX_PCC_BAND_NUM];
...
typedef struct
{
    ...
    NV_PA_TYPE_FLAG_STRU                stpaTypeInfo; /*指示pa芯片是否是eagle*/
