...
#define TAF_CALL_MAX_FLASH_DIGIT_LEN                        (255)
...
enum MN_CALL_EVENT_ENUM
{
    ...
    /* Added by l60609 for CDMA 1X Iteration 2, 2014-9-3, begin */
    TAF_CALL_EVT_SEND_FLASH_CNF,                            /* _H2ASN_MsgChoice TAF_CALL_EVT_SEND_FLASH_CNF_STRU */
...
enum TAF_CS_CAUSE_ENUM
{
    ...
    TAF_CS_CAUSE_XCALL_ACCEPT_BY_BS,                                                                            /* BS Reject, used in Register process */
    ...
    TAF_CS_CAUSE_XCALL_NOT_ACCEPT_BY_BS,                                                                        /* BS Reject, Call not Redial */
    TAF_CS_CAUSE_XCALL_ALREADY_IN_TCH,                                                                          /* Already In Traffic Channel, no need dial */
...
{
    VOS_MSG_HEADER
    VOS_UINT16                          usMsgId;                                /* 消息名 */
    VOS_UINT8                           aucRsved[2];                            /* 保留 */
    MN_CLIENT_ID_T                      usClientId;
...
typedef struct
{
    ...
    VOS_UINT8                           ucDigitNum;
    VOS_UINT8                           aucReserved[1];
    VOS_UINT8                           aucDigit[TAF_CALL_MAX_NUM_DIGIT_LEN];
...
typedef struct
{
    ...
    VOS_UINT8                           ucDigitNum;
    VOS_UINT8                           aucRsved[2];
    VOS_UINT8                           aucDigitNum[TAF_CALL_MAX_NUM_DIGIT_LEN];
