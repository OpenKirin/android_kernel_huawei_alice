...
VOS_UINT32 R_ITF_SetGprsFlowCtrl(VOS_VOID)
{
    ...
    /* 发消息 */
    (VOS_VOID)PS_SEND_MSG(UEPS_PID_FLOWCTRL_C, pstFcSetGprsInd);
...
VOS_UINT32 R_ITF_GprsFlowCtrlNotify(VOS_VOID)
{
    ...
    /* 发消息 */
    (VOS_VOID)PS_SEND_MSG(UEPS_PID_FLOWCTRL_C, pstFcGprsNotify);
...
VOS_UINT32 R_ITF_StopGprsFlowCtrl(VOS_VOID)
{
    ...
    /* 发消息 */
    (VOS_VOID)PS_SEND_MSG(UEPS_PID_FLOWCTRL_C, pstFcStopGprsInd);
