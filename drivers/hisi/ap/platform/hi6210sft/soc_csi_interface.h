...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int bypass_2ecc_tst : 1;
...
typedef union
{
    ...
    struct
    {
        unsigned int di4_dt : 6;
        unsigned int di4_vc : 2;
        unsigned int di5_dt : 6;
        unsigned int di5_vc : 2;
        unsigned int di6_dt : 6;
        unsigned int di6_vc : 2;
        unsigned int di7_dt : 6;
        unsigned int di7_vc : 2;
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int err_l_bndry_match_di4 : 1;
        unsigned int err_l_bndry_match_di5 : 1;
        unsigned int err_l_bndry_match_di6 : 1;
        unsigned int err_l_bndry_match_di7 : 1;
        unsigned int err_l_seq_di4 : 1;
        unsigned int err_l_seq_di5 : 1;
        unsigned int err_l_seq_di6 : 1;
        unsigned int err_l_seq_di7 : 1;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int mask_err_l_bndry_match_di4 : 1;
        unsigned int mask_err_l_bndry_match_di5 : 1;
        unsigned int mask_err_l_bndry_match_di6 : 1;
        unsigned int mask_err_l_bndry_match_di7 : 1;
        unsigned int mask_err_l_seq_di4 : 1;
        unsigned int mask_err_l_seq_di5 : 1;
        unsigned int mask_err_l_seq_di6 : 1;
        unsigned int mask_err_l_seq_di7 : 1;
        unsigned int reserved : 8;
    } reg;
} SOC_CSI_MASK2_UNION;
#endif
