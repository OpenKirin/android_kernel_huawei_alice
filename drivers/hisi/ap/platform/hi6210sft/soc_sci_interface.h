...
typedef union
{
    ...
    struct
    {
        unsigned short txtide : 4;
        unsigned short rxtide : 4;
        unsigned short reserved : 8;
    } reg;
} SOC_SCI_TIDE_UNION;
#endif
#define SOC_SCI_TIDE_txtide_START (0)
#define SOC_SCI_TIDE_txtide_END (3)
#define SOC_SCI_TIDE_rxtide_START (4)
#define SOC_SCI_TIDE_rxtide_END (7)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned short value;
...
typedef union
{
    ...
    struct
    {
        unsigned short txcount : 4;
        unsigned short reserved : 12;
    } reg;
} SOC_SCI_TXCOUNT_UNION;
#endif
#define SOC_SCI_TXCOUNT_txcount_START (0)
#define SOC_SCI_TXCOUNT_txcount_END (3)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned short value;
    struct
    {
        unsigned short rxcount : 4;
        unsigned short reserved : 12;
    } reg;
} SOC_SCI_RXCOUNT_UNION;
#endif
#define SOC_SCI_RXCOUNT_rxcount_START (0)
#define SOC_SCI_RXCOUNT_rxcount_END (3)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned short value;
