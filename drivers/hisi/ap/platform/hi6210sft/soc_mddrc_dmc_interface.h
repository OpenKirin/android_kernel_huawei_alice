...
typedef union
{
    ...
    struct
    {
        unsigned int sfc_col : 12;
        unsigned int sfc_row : 20;
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int load_int_mask : 1;
        unsigned int dat_min_int_mask : 1;
        unsigned int dat_max_int_mask : 1;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int load_rint : 1;
        unsigned int dat_min_rint : 1;
        unsigned int dat_max_rint : 1;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int load_intsts : 1;
        unsigned int dat_min_intsts : 1;
        unsigned int dat_max_intsts : 1;
...
typedef union
{
    ...
    struct
    {
        unsigned int dmc_cmd_sum : 16;
        unsigned int dmc_dat_sum : 16;
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int cmd_dat_stat_en : 1;
    } reg;
