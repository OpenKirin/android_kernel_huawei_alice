#ifndef __EFFECT_IMX219_LITEON_H__
#define __EFFECT_IMX219_LITEON_H__
...
/*isp_reg_t*/
{
	...
	{0x1c596,0x46},//y-target-highhanchen
	{0x1c146,0x26},//y-targethanchen
	{0x1c14a,0x03},
	{0x1c14b,0x0a},
	...
	{0x1c49f,0x00},//RGBGamma[7:0]ManualgammaandRGBgammashouldbesame
	{0x1c4a2,0x00},//MaxRGBGammaGain[15:8]//???shouldbecheckedbyRichard
	{0x1c4a3,0x70},//MaxRGBGammaGain[7:0]//???shouldbecheckedbyRichard
	...
	{0x1d999,0x00},
	{0x1d99a,0x70},//lowgainslope
	{0x1d99b,0x70},//highgainslope
	{0x1d99c,0x70},//darkimageslope
	{0x1d982,0x14},//Low gain threshold
    {0x1d983,0x60},//High gain threshold
	{0x1d99d,0x14},//lowbrightthres
	{0x1d99e,0x20},//highbrightthres
	//curve$)AcPV5
	{0x1c591,0x01},//enablea daptive curve
	{0x1c592,0xa0},//lowgainthreshold
	{0x1c593,0xf0},//highgainthreshold
	...
	//highcurve
	{0x1d985, 0x18},//high gain curve 00
	{0x1d986, 0x28},//high gain curve 01
	{0x1d987, 0x35},
	{0x1d988, 0x3d},
	{0x1d989, 0x46},
	{0x1d98a, 0x4f},
	...
	/*enable lensOnline*/
	{0x1c245,0x01},//bit0:threeprofile,colortemperaturebasedlensshadingcorrectionmode1:enable0:disable;bit1,1=usetwoprofiles
	{0x1d9c6,0x00}, //org:0x00
...
//LenC Setting
//OVISP LENC setting for D light in pipeline 1
    {0x1c264,0x17},
    {0x1c265,0x0e},
    {0x1c266,0x0a},
    {0x1c267,0x09},
    ...
    {0x1c2b8,0x22},
    {0x1c2b9,0x22},
//OVIS0x0dP LENC setting for C light in pipeline 1
    {0x1c2ba,0x17},
    {0x1c2bb,0x0d},
    {0x1c2bc,0x09},
    {0x1c2bd,0x09},
    ...
    {0x1c30d,0x1f},
    {0x1c30e,0x1f},
    {0x1c30f,0x20},//OVISP,LENC setting for A light in pipeline 1 
    {0x1c310,0x18},
    {0x1c311,0x0f},
    {0x1c312,0x0b},
    {0x1c313,0x0a},
	...
	{0x1da0b,0x84},//RgainforAlowlight
	...
	{0x1C1FC,0x0},//cmxleftdelta,daylight
	{0x1C1FD,0x15},
	{0x1C1FE,0xFF},
	{0x1C1FF,0xC1},
	{0x1C200,0x0},
	...
	/*autouvsaturation*///modified
	{0x1c4e8,0x01},//Enable
	{0x1c4e9,0xbf},//gainthreshold140-->0b
	{0x1c4ea,0xd0},//gainthreshold278-->0d
	{0x1c4eb,0x73},//keepbackfornewcmx0310
	{0x1c4ec,0x63},//keepbackfornewcmx0310
	...
	//threshold of PL each corresponding to one of 1x, 2x, бн 32x sensor gain, when THY = 0x04
	{0x6732a,0x20}, //gain1X
	{0x6732b,0x20}, //gain2X
	{0x6732c,0x20}, //gain4X
	{0x6732d,0x20}, //gain8X
...
#endif//__EFFECT_IMX219_LITEON_H__
