#ifndef __EFFECT_HI843S_OFILM_H__
#define __EFFECT_HI843S_OFILM_H__
...
/*isp_reg_t*/
{
	...
	{0x1c596,0x45},//y-target-high
	{0x1c146,0x25},//y-target
	{0x1c14a,0x03},
	{0x1c14b,0x06},
...
{0x1d8bf, 0x00},
	...
	/*awbshift*/
	{0x1d8e8,0x07},//0x01:EnableAWBShift,0x02:EnableBrShift,0x04:enableMultipleMap,turnoffawbshiftfortest
	/*newAWBshift*/
	...
	/*autouvsaturation*/
	{0x1c4e8,0x01},//Enable
	{0x1c4e9,0xaf},//gainthreshold140-->0b
	...
	{0x67301,0x10},//[6:0]r_s0_sigma_1_i-gain-2X
	{0x67302,0x1f},//[6:0]r_s0_sigma_2_i
	{0x67303,0x22},//[6:0]r_s0_sigma_3_i
	{0x67304,0x30},//[6:0]r_s0_sigma_4_i-gain-16X
	{0x67305,0x3a},//[6:0]r_s0_sigma_5_i-gain-32X
	...
	{0x65602,0x00},
	{0x65603,0xa0},//y00215412changesharpnesshighgainthreshod0x40->0x6020120814
	{0x65604,0x00},
	{0x65605,0x00},
	{0x65606,0x00},
	{0x65607,0x00},
	...
	{0x6560c,0x00},//highgain,minvalue
...
/*manual_wb_param*/
{
	...
	{0x0105,0x0080,0x0080,0x0080},/*INCANDESCENT2800K*/
	{0x00d9,0x0080,0x0080,0x00b3},/*FLUORESCENT4200K*/
	{0x00a0,0x00a0,0x00a0,0x00a0},/*WARM_FLUORESCENT,y36721todo*/
	{0x00af,0x0080,0x0080,0x00b9},/*DAYLIGHT5000K*/
	{0x0091,0x0080,0x0080,0x00d6},/*CLOUDY_DAYLIGHT6500K*/
	{0x00a0,0x00a0,0x00a0,0x00a0},/*TWILIGHT,y36721todo*/
	{0x0110,0x0080,0x0080,0x0080},/*CANDLELIGHT,2300K*/
},
...
#endif//__EFFECT_HI843S_OFILM_H__
