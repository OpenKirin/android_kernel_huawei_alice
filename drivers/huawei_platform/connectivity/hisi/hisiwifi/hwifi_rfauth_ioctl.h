...
enum HWIFI_ANDROID_IOCTL_CMD
{
    ...
    HWIFI_ANDROID_IOCTL_CMD_RX_RSSI_GET,              /* get rx rssi */
    HWIFI_ANDROID_IOCTL_CMD_ALWAYS_TX_CONFIG,         /* 配置常发模式参数 */
...
typedef struct wifi_android_ioctl_data_struct
{
    ...
    union
    {
        ...
        int16             rx_rssi;                  /* rx rssi */
        uint32            always_tx_param;          /* always tx mode's parameter */
    }pri_data;
