...
/****************************************************************************
  Function:     hisi_battery_charge_full_design
  Description:  return the design full charge capacity of battery in mAh
  Input:        NA
  Output:       NA
  Return:       the reture value is mAh or < 0 if something fails.
****************************************************************************/
int hisi_battery_charge_full_design(void)
{
    /*declare the local variable of struct hisi_coul_ops*/
    LOCAL_HISI_COUL_OPS();
    /*execute the operation of coul module*/
    HISI_EXEC_COUL_OP(battery_charge_full_design);
