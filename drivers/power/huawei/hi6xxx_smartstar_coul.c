...
/*******************************************************
  Function:     smartstar_battery_charge_full_design
  Description:  battery full charge capacity design
  Input:        NULL
  Output:       NULL
  Return:       fcc design
********************************************************/
int smartstar_battery_charge_full_design(void)
{
    struct smartstar_coul_device *di = g_smartstar_coul_dev;
...
/*******************************************************
  Function:     smartstar_get_battery_vbat_max
  Description:  battery voltage max design
  Input:        NULL
  Output:       NULL
  Return:       battery voltage max design
********************************************************/
int smartstar_get_battery_vbat_max(void)
{
    struct smartstar_coul_device *di = g_smartstar_coul_dev;
    return di->batt_data->max_voltagemV;
}
...
static ssize_t hisi_coul_show_battery_brand_name(struct device *dev,
                  struct device_attribute *attr,
                  char *buf)
{
    struct smartstar_coul_device *di = g_smartstar_coul_dev;
...
static DEVICE_ATTR(gaugelog, (S_IWUSR | S_IRUGO),
                ...
                NULL);
static DEVICE_ATTR(battery_brand_name, (S_IRUGO),
                hisi_coul_show_battery_brand_name,
                NULL);
static struct attribute *coul_attributes[] = {
    ...
    &dev_attr_battery_brand_name.attr,
    NULL,
};
...
#endif
    coul_ops->battery_charge_full_design = smartstar_battery_charge_full_design;
    coul_ops->battery_vbat_max = smartstar_get_battery_vbat_max;
    di->ops = coul_ops;
